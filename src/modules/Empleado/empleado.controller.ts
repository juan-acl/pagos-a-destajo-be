...
import { CreateEmpleadoDto, UpdateEmpleadoDto, LoginDto } from "./empleado.dto";
...
export class EmpleadoController {
  ...
  login = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      HttpResponse.ok(res, data, "Login exitoso");
    } catch (e) {
      if (e instanceof NotFoundError) return HttpResponse.notFound(res, "Credenciales incorrectas");
      next(e);
    }
  };
